...
const EcosystemFeatureMatrixSection = () => {
  ...
  const features = [
    { id: 1, title: 'Multi Branch System', category: 'Operations', image: '/assets/features/feat_multi_branch.webp', desc: 'Separation of AI into Sales, Support, and CS Branch Agents connected for seamless cross-departmental coordination.', details: ['Branch Sales Agent', 'Branch Support Agent', 'Branch CS Agent', 'Cross-branch Coordination', 'Unified CRM View'] },
    { id: 2, title: 'Long Memory & Cross-Platform', category: 'Sales', image: '/assets/features/feat_cross_platform.webp', desc: 'Remembers customer details across platforms (WhatsApp, Instagram, Facebook, TikTok, Email) for deeply personalized service.', details: ['WhatsApp History Sync', 'Instagram DM Memory', 'Facebook Messenger Log', 'Email Thread Tracking', 'Unified Customer Timeline'] },
    { id: 3, title: 'Integrated CRM Engine', category: 'Sales', image: '/assets/features/feat_crm_engine.webp', desc: 'Automatically logs customer data from conversations, last message history, and key operational notes.', details: ['Auto Contact Creation', 'Conversation History', 'Smart Contact Tags', 'Custom Notes', 'Broadcast Messaging', 'Follow-up Scheduling'] },
    { id: 4, title: 'Automated Follow-Up & Tagging', category: 'Sales', image: '/assets/features/feat_auto_followup.webp', desc: 'Automated lead tagging (Potential, Warm, Cold) & scheduled auto follow-ups to increase conversion rates.', details: ['Auto Lead Scoring', 'Warm/Cold Tagging', 'Scheduled Follow-ups', 'Smart Reminders', 'Conversion Analytics'] },
    { id: 5, title: 'Support Ticketing System', category: 'Operations', image: '/assets/features/feat_support_ticket.webp', desc: 'Dedicated support queue ticket creation whenever customers have specific issues requiring team attention.', details: ['Auto Ticket Creation', 'Priority Queue', 'Agent Assignment', 'Resolution Tracking', 'Customer Feedback Loop'] },
    { id: 6, title: 'Invoicing & Receipt Generator', category: 'Finance', image: '/assets/features/feat_invoice_gen.webp', desc: 'Canvas editor for invoice & receipt templates generated automatically by AI upon successful transactions.', details: ['Auto Invoice Generation', 'Custom Templates', 'PDF Export', 'Payment Link Embed', 'Tax Calculation'] },
    { id: 7, title: 'Midtrans Payment Integration', category: 'Finance', image: '/assets/features/feat_midtrans_pay.webp', desc: 'Midtrans payment gateway integration to generate payment links and verify transactions automatically.', details: ['Payment Link Generator', 'Auto Verification', 'Refund Processing', 'Multi-payment Methods', 'Settlement Reports'] },
    { id: 8, title: 'Multi-Model Inventory Engine', category: 'Operations', image: '/assets/features/feat_inventory_eng.webp', desc: 'Supports diverse business models: schedule slots, product stock, table reservations, and rental/travel units.', details: ['Slot-based Inventory', 'Stock Management', 'Reservation System', 'Rental Unit Tracking', 'Real-time Availability'] },
    { id: 9, title: 'Smart Scheduling & Reminders', category: 'Operations', image: '/assets/features/feat_scheduling.webp', desc: 'Tracks trip dates, deposit/installment schedules, and triggers auto follow-ups right on target dates.', details: ['Trip Scheduling', 'Payment Reminders', 'Auto Follow-up', 'Calendar Integration', 'Overdue Alerts'] },
    { id: 10, title: 'Flexible Persona & SOP', category: 'Sales', image: '/assets/features/feat_persona_sop.webp', desc: 'Customize service personas, tone of voice, and business SOPs according to company rules.', details: ['Custom Persona Builder', 'Language Style Tuning', 'SOP Template Library', 'Rule-based Routing', 'Behavior Presets'] },
    { id: 11, title: 'Real-Time Excel Sheet Sync', category: 'Integrations', image: '/assets/features/feat_excel_sync.webp', desc: 'Bidirectional sync for business Excel & Google Sheet files updated by AI in real time during customer interactions.', details: ['Bidirectional Sync', 'Real-time Updates', 'Google Sheets Support', 'Custom Mapping', 'Conflict Resolution'] },
    { id: 12, title: 'Smart Pipeline Indicator', category: 'Sales', image: '/assets/features/feat_pipeline_ind.webp', desc: 'Visual pipeline indicator tracking customer position (exploration stage to prospective closing).', details: ['Visual Pipeline View', 'Stage Auto-detection', 'Progress Tracking', 'Bottleneck Alerts', 'Conversion Forecasting'] },
    { id: 13, title: 'AI Agent Talk Session', category: 'Operations', image: '/assets/features/feat_talk_session.webp', desc: 'Interactive text & voice call interview onboarding to populate your business Knowledge Base & SOPs.', details: ['Voice Interview Mode', 'Text Interview Mode', 'Auto KB Population', 'SOP Extraction', 'Quick Onboarding Flow'] },
    { id: 14, title: 'Bring Your Old Data (PDF/Excel)', category: 'Integrations', image: '/assets/features/feat_bring_old_data.webp?v=6', desc: 'Upload legacy PDF/Excel files -> AI extracts and maps them automatically into CRM, Inventory, & Sheets.', details: ['PDF Data Extraction', 'Excel Import', 'Auto Field Mapping', 'Duplicate Detection', 'Bulk Import Support'] },
    { id: 15, title: 'Interactive Business Copilot', category: 'Integrations', image: '/assets/features/feat_copilot_cmd.webp?v=6', desc: 'Natural language copilot commands for business owners ("How many leads today?", "Follow up John", "Update item Y").', details: ['Natural Language Commands', 'Quick Actions', 'Data Lookup', 'Task Execution', 'Report Generation'] },
    { id: 16, title: 'Human in the Loop (HITL)', category: 'Operations', image: '/assets/features/feat_human_loop.webp?v=6', desc: 'Interactive approval dashboard whenever AI encounters edge-case requests outside standard SOPs.', details: ['Approval Dashboard', 'Smart Escalation', 'Context Preservation', 'Manual Override', 'Audit Trail'] },
    { id: 17, title: 'Telegram Smart Routing', category: 'Integrations', image: '/assets/features/feat_telegram_route.webp?v=6', desc: 'Intelligent routing for transaction notifications & approvals sent separately to owners, managers, or admins.', details: ['Multi-role Routing', 'Approval Notifications', 'Transaction Alerts', 'Status Updates', 'Command Responses'] },
  ];
